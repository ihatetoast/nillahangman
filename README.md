...
For this version, the user will choose one of the realms (air, land, or water) and be given an animal from one of those zones. To follow the original rules, the first and last letters will be given, and the game will let the player know what realm the animal comes from.
